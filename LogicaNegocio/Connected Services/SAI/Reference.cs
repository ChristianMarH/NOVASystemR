...
namespace LogicaNegocio.SAI {
    ...
    public interface ISAI {
        ...
        LogicaNegocio.SAI.Autenticar AutenticarUsuario(string Dominio, string CuentaRed, string Contraseña, System.Nullable<int> Sistema);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISAI/AutenticarUsuario", ReplyAction="http://tempuri.org/ISAI/AutenticarUsuarioResponse")]
        System.Threading.Tasks.Task<LogicaNegocio.SAI.Autenticar> AutenticarUsuarioAsync(string Dominio, string CuentaRed, string Contraseña, System.Nullable<int> Sistema);
        ...
        LogicaNegocio.SAI.Mensaje AutenticarExterno(LogicaNegocio.SAI.Token token, int pServicioId, int pMetodoId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISAI/AutenticarExterno", ReplyAction="http://tempuri.org/ISAI/AutenticarExternoResponse")]
        System.Threading.Tasks.Task<LogicaNegocio.SAI.Mensaje> AutenticarExternoAsync(LogicaNegocio.SAI.Token token, int pServicioId, int pMetodoId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISAIChannel : LogicaNegocio.SAI.ISAI, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SAIClient : System.ServiceModel.ClientBase<LogicaNegocio.SAI.ISAI>, LogicaNegocio.SAI.ISAI {
        ...
        public LogicaNegocio.SAI.Autenticar AutenticarUsuario(string Dominio, string CuentaRed, string Contraseña, System.Nullable<int> Sistema) {
            return base.Channel.AutenticarUsuario(Dominio, CuentaRed, Contraseña, Sistema);
        }
        
        public System.Threading.Tasks.Task<LogicaNegocio.SAI.Autenticar> AutenticarUsuarioAsync(string Dominio, string CuentaRed, string Contraseña, System.Nullable<int> Sistema) {
            return base.Channel.AutenticarUsuarioAsync(Dominio, CuentaRed, Contraseña, Sistema);
        }
        
        public LogicaNegocio.SAI.Mensaje AutenticarExterno(LogicaNegocio.SAI.Token token, int pServicioId, int pMetodoId) {
            return base.Channel.AutenticarExterno(token, pServicioId, pMetodoId);
        }
        
        public System.Threading.Tasks.Task<LogicaNegocio.SAI.Mensaje> AutenticarExternoAsync(LogicaNegocio.SAI.Token token, int pServicioId, int pMetodoId) {
